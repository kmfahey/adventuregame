...
LOREM_IPSUM_WRAPPED = """Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas malesuada mi vel
elementum facilisis. Nulla ac felis in diam dictum dignissim in eget neque. Sed
ultrices, mauris sed pellentesque rutrum, dui augue elementum ante, vel ultricies
diam metus nec risus. Cras finibus, orci ac pellentesque finibus, orci lorem tempus
justo, eget mollis nibh justo et dolor. Sed commodo magna erat, sed elementum nulla
feugiat a. Ut faucibus gravida felis ut mollis. In in ante metus. Pellentesque
habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
Aenean est nibh, ultrices in lacinia vel, feugiat eu nibh. Pellentesque ac aliquet
risus. Aliquam erat volutpat. Aliquam bibendum felis sit amet vulputate molestie.
Vivamus scelerisque lacinia mauris non rutrum. Nunc tempor quis turpis eget
tincidunt.

Vivamus ac ultricies dolor, vel condimentum sapien. Sed semper facilisis pulvinar.
Fusce sit amet vulputate nibh. Donec consequat scelerisque odio non facilisis. Ut
nibh elit, iaculis at justo id, iaculis efficitur turpis. Donec fringilla volutpat
ligula at blandit. Vestibulum congue cursus tellus, id commodo ex fringilla ut.
Nullam eu leo pellentesque, consectetur felis nec, ultricies enim. Nunc sit amet
elementum orci. Aenean quis dolor in nisl posuere finibus gravida eu urna. Ut tempor,
neque id ornare porta, risus turpis rhoncus justo, in dapibus lacus nunc vel elit.
Pellentesque vulputate pellentesque purus, ac imperdiet urna sagittis sodales. Donec
varius orci sapien.

Fusce tristique blandit ex, vel interdum libero dignissim non. Sed ut libero rutrum,
efficitur diam ullamcorper, pellentesque tortor. Sed vitae nisi eget est luctus
volutpat sit.
"""
...
class Test_Lexical_Number_to_Digits(unittest.TestCase):
    ...
    def test_lexical_number_to_digits(self):
        ...
        self.assertEqual(advg.lexical_number_to_digits('fourty-three'), 43)
