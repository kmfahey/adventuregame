...
class Test_Attack_1(unittest.TestCase):
    ...
    def test_attack_2(self):
        ...
        self.assertIsInstance(
            result[0], advg.stmsg.attack.YouHaveNoWeaponOrWandEquippedGSM
        )
        self.assertEqual(
    ...
    def test_attack_3(self):
        result = self.command_processor.process("attack sorcerer")
        self.assertIsInstance(result[0], advg.stmsg.attack.OpponentNotFoundGSM)
    ...
    def test_attack_vs_be_attacked_by_vs_character_death_2(self):
        results = tuple()
        while not len(results) or not isinstance(
            results[-1], advg.stmsg.various.FoeDeathGSM
        ):
            self.setUp()
            results = self.command_processor.process("attack kobold")
            while not (
                isinstance(results[-1], advg.stmsg.be_atkd.CharacterDeathGSM)
                or isinstance(results[-1], advg.stmsg.various.FoeDeathGSM)
            ):
                results += self.command_processor.process("attack kobold")
            for index in range(0, len(results)):
                command_results = results[index]
                if isinstance(command_results, advg.stmsg.attack.AttackHitGSM):
                ...
                elif isinstance(command_results, advg.stmsg.attack.AttackMissedGSM):
                    self.assertEqual(results[index].creature_title, "kobold")
                    self.assertEqual(
                        results[index].message,
                ...
                elif isinstance(command_results, advg.stmsg.be_atkd.AttackedAndHitGSM):
                    self.assertEqual(results[index].creature_title, "kobold")
                    self.assertTrue(isinstance(results[index].damage_done, int))
                ...
                elif isinstance(command_results, advg.stmsg.various.FoeDeathGSM):
                    self.assertEqual(results[index].creature_title, "kobold")
                    self.assertRegex(results[index].message, r"The kobold is slain.")
                elif isinstance(command_results, advg.stmsg.be_atkd.CharacterDeathGSM):
        ...
        self.assertIsInstance(
            self.game_state.rooms_state.cursor.container_here, advg.Corpse
        )
...
class Test_Attack_2(unittest.TestCase):
    ...
    def test_attack_1(self):
        ...
        while True:
            ...
            while (
                not any(
                    isinstance(result, advg.stmsg.attack.AttackMissedGSM)
                    for result in results
                )
                and not any(
                    isinstance(result, advg.stmsg.attack.AttackHitGSM)
                    for result in results
                )
            ) or (
                isinstance(
        ...
        for index in range(0, len(results)):
            ...
            if isinstance(result, advg.stmsg.attack.AttackMissedGSM):
            ...
            elif isinstance(result, advg.stmsg.attack.AttackHitGSM):
                self.assertEqual(result.creature_title, "kobold")
                self.assertEqual(result.weapon_type, "wand")
                self.assertRegex(
                    result.message,
    ...
    def test_cast_spell4(self):
        ...
        if not isinstance(result[1], advg.stmsg.various.FoeDeathGSM):
            ...
            self.assertRegex(
                ...
                + "unerringly strikes the kobold. You have done \d+ points of "
...
class Test_Leave(unittest.TestCase):
    ...
    def test_leave_3(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.leave.LeftRoomGSM)
    ...
    def test_leave_5(self):
        ...
        result = self.command_processor.process("leave using north door")
        self.assertIsInstance(result[0], advg.stmsg.leave.DoorIsLockedGSM)
        self.assertEqual(result[0].compass_dir, "north")
        self.assertEqual(result[0].portal_type, "door")
        self.assertEqual(
            result[0].message,
        ...
        self.assertEqual(result[0].compass_dir, "north")
        self.assertEqual(result[0].message, "You leave the room via the north door.")
        self.assertIsInstance(result[1], advg.stmsg.leave.WonTheGameGSM)
        self.assertEqual(
            result[1].message,
...
class Test_Look_At_1(unittest.TestCase):
    ...
    def test_look_at_1(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.lookat.FoundCreatureHereGSM)
        self.assertEqual(
    ...
    def test_look_at_2(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.lookat.FoundContainerHereGSM)
        self.assertEqual(
    ...
    def test_look_at_13(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.lookat.FoundDoorOrDoorwayGSM)
        self.assertEqual(result[0].compass_dir, "north")
...
class Test_Look_At_2(unittest.TestCase):
    ...
    def test_look_at_3(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.lookat.FoundItemOrItemsHereGSM)
    ...
    def test_look_at_10(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.lookat.FoundNothingGSM)
        self.assertEqual(result[0].item_title, "mana potion")
    ...
    def test_look_at_19(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.various.AmbiguousDoorSpecifierGSM)
...
class Test_Pick_Up(unittest.TestCase):
    ...
    def test_pick_up_2(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.pickup.AmountToPickUpUnclearGSM)
        self.assertEqual(
    ...
    def test_pick_up_3(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.pickup.ItemNotFoundGSM)
        self.assertEqual(result[0].item_title, "gold coin")
    ...
    def test_pick_up_7(self):
        ...
        self.assertIsInstance(
            result[0], advg.stmsg.pickup.TryingToPickUpMoreThanIsPresentGSM
        )
        self.assertEqual(result[0].item_title, "mana potion")
    ...
    def test_pick_up_8(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.pickup.ItemPickedUpGSM)
        self.assertEqual(result[0].item_title, "mana potion")
    ...
    def test_pick_up_11(self):
        ...
        self.assertIsInstance(
            result[0], advg.stmsg.pickup.CantPickUpChestCorpseCreatureOrDoorGSM
        )
...
class Test_Unlock(unittest.TestCase):
    ...
    def test_unlock_3(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.unlock.DontPossessCorrectKeyGSM)
    ...
    def test_unlock_8(self):
        ...
        self.assertIsInstance(result[0], advg.stmsg.unlock.ElementNotUnlockableGSM)
        self.assertEqual(result[0].target_title, "mana potion")
        self.assertEqual(result[0].target_type, "potion")
        self.assertEqual(
            result[0].message,
