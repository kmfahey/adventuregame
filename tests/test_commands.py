...
class Test_Attack_1(unittest.TestCase):
    ...
    def test_attack_1(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_CommandBadSyntax)
    ...
    def test_attack_2(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_Attack_YouHaveNoWeaponOrWandEquipped)
    ...
    def test_attack_3(self):
        result = self.command_processor.process('attack sorcerer')
        self.assertIsInstance(result[0], advg.Stmsg_Attack_OpponentNotFound)
    ...
    def test_attack_vs_be_attacked_by_vs_character_death_2(self):
        results = tuple()
        while not len(results) or not isinstance(results[-1], advg.statemsgs.various.FoeDeath):
            self.setUp()
            results = self.command_processor.process('attack kobold')
            while not (isinstance(results[-1], advg.Stmsg_Batkby_CharacterDeath)
                       or isinstance(results[-1], advg.statemsgs.various.FoeDeath)):
                results += self.command_processor.process('attack kobold')
            for index in range(0, len(results)):
                command_results = results[index]
                if isinstance(command_results, advg.Stmsg_Attack_AttackHit):
                ...
                elif isinstance(command_results, advg.Stmsg_Attack_AttackMissed):
                    self.assertEqual(results[index].creature_title, 'kobold')
                    self.assertEqual(results[index].message, 'Your attack on the kobold missed. It turns to attack!')
                elif isinstance(command_results, advg.Stmsg_Batkby_AttackedAndNotHit):
                    self.assertEqual(results[index].creature_title, 'kobold')
                    self.assertEqual(results[index].message, 'The kobold attacks! Their attack misses.')
                elif isinstance(command_results, advg.Stmsg_Batkby_AttackedAndHit):
                    self.assertEqual(results[index].creature_title, 'kobold')
                    self.assertTrue(isinstance(results[index].damage_done, int))
                ...
                elif isinstance(command_results, advg.statemsgs.various.FoeDeath):
                    self.assertEqual(results[index].creature_title, 'kobold')
                    self.assertRegex(results[index].message, r'The kobold is slain.')
                elif isinstance(command_results, advg.Stmsg_Batkby_CharacterDeath):
            ...
            self.assertRegex(results_str_join, r'(Stmsg_Attack_Attack(Hit|Missed) '
                                               r'Stmsg_Batkby_AttackedAnd(Not)?Hit)+ '
                                               r'(Stmsg_Attack_AttackHit FoeDeath'
                                               r'|Stmsg_Batkby_CharacterDeath)')
...
class Test_Attack_2(unittest.TestCase):
    ...
    def test_attack_1(self):
        ...
        while True:
            ...
            results = self.command_processor.process('attack kobold')
            while ((not any(isinstance(result, advg.Stmsg_Attack_AttackMissed) for result in results)
                    and not any(isinstance(result, advg.Stmsg_Attack_AttackHit) for result in results))
                    or (isinstance(results[-1], (advg.Stmsg_Attack_AttackHit, advg.Stmsg_Batkby_CharacterDeath)))):
                results += self.command_processor.process('attack kobold')
            if isinstance(results[-1], (advg.Stmsg_Attack_AttackHit, advg.Stmsg_Batkby_CharacterDeath)):
                continue
            else:
                break
        for index in range(0, len(results)):
            result = results[index]
            if isinstance(result, advg.Stmsg_Attack_AttackMissed):
                ...
                self.assertEqual(result.message, 'A bolt of energy from your wand misses the kobold. It turns to '
                                                 'attack!')
            elif isinstance(result, advg.Stmsg_Attack_AttackHit):
                self.assertEqual(result.creature_title, 'kobold')
                self.assertEqual(result.weapon_type, 'wand')
...
class Test_Begin_Game(unittest.TestCase):
    ...
    def test_begin_game_1(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_Begin_NameOrClassNotSet)
    ...
    def test_begin_game_5(self):
        ...
        self.command_processor.process('set name to Niath')
        result = self.command_processor.process('begin game')
        self.assertIsInstance(result[0], advg.Stmsg_Begin_GameBegins)
        self.assertEqual(result[0].message, 'The game has begun!')
        self.assertTrue(self.command_processor.game_state.game_has_begun)
        self.assertIsInstance(result[-1], advg.statemsgs.various.EnteredRoom)
    ...
    def test_begin_game_6(self):
        ...
        self.assertEqual(result[0].message, 'The game has begun!')
        self.assertTrue(self.command_processor.game_state.game_has_begun)
        self.assertIsInstance(result[1], advg.statemsgs.various.ItemEquipped)
        ...
        self.assertIsInstance(result[2], advg.statemsgs.various.ItemEquipped)
        ...
        self.assertIsInstance(result[3], advg.statemsgs.various.ItemEquipped)
        ...
        self.assertIsInstance(result[4], advg.statemsgs.various.EnteredRoom)
    ...
    def test_begin_game_7(self):
        ...
        self.assertRegex(result[2].message, r"^You're now wielding a rapier. Your attack bonus is now [\d+-]+ and your"
                                            r' weapon damage is now [\dd+-]+.$')
        self.assertIsInstance(result[3], advg.statemsgs.various.EnteredRoom)
    ...
    def test_begin_game_9(self):
        ...
        self.assertRegex(result[1].message, r"^You're now wielding a staff. Your attack bonus is now [\d+-]+ and your"
                                            r' weapon damage is now [\dd+-]+.$')
        self.assertIsInstance(result[2], advg.statemsgs.various.EnteredRoom)
...
class Test_Cast_Spell(unittest.TestCase):
    ...
    def test_cast_spell1(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_CommandClassRestricted)
    ...
    def test_cast_spell3(self):
        ...
        result = self.command_processor.process('cast spell')
        self.assertIsInstance(result[0], advg.statemsgs.castspl.InsufficientMana)
    ...
    def test_cast_spell4(self):
        ...
        self.game_state.game_has_begun = True
        result = self.command_processor.process('cast spell')
        self.assertIsInstance(result[0], advg.statemsgs.castspl.CastDamagingSpell)
        ...
        self.assertIsInstance(result[1], (advg.statemsgs.various.FoeDeath,
                                          advg.Stmsg_Batkby_AttackedAndNotHit,
                                          advg.Stmsg_Batkby_AttackedAndHit))
        if not isinstance(result[1], advg.statemsgs.various.FoeDeath):
            spell_cast_count = 1
    ...
    def test_cast_spell5(self):
        ...
        self.game_state.game_has_begun = True
        result = self.command_processor.process('cast spell')
        self.assertIsInstance(result[0], advg.statemsgs.castspl.CastHealingSpell)
        self.assertRegex(result[0].message, r'You cast a healing spell on yourself.')
        self.assertIsInstance(result[1], advg.statemsgs.various.UnderwentHealingEffect)
...
class Test_Close(unittest.TestCase):
    ...
    def test_close_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.close.ElementIsAlreadyClosed)
    ...
    def test_close_3(self):
        ...
        result = self.command_processor.process(f'close {self.chest_title}')
        self.assertIsInstance(result[0], advg.statemsgs.close.ElementHasBeenClosed)
        self.assertEqual(result[0].target, self.chest_title)
    ...
    def test_close_5(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.DoorNotPresent)
    ...
    def test_close_9(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.close.ElementNotCloseable)
...
class Test_Drink(unittest.TestCase):
    ...
    def test_drink2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drink.ItemNotInInventory)
    ...
    def test_drink3(self):
        ...
        result = self.command_processor.process('drink health potion')
        self.assertIsInstance(result[0], advg.statemsgs.various.UnderwentHealingEffect)
    ...
    def test_drink6(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drink.DrankManaPotion)
    ...
    def test_drink9(self):
        ...
        self.command_processor.game_state.character.pick_up_item(mana_potion)
        result = self.command_processor.process('drink mana potion')
        self.assertIsInstance(result[0], advg.statemsgs.drink.DrankManaPotionWhenNotASpellcaster)
    ...
    def test_drink10(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drink.ItemNotDrinkable)
    ...
    def test_drink11(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drink.TriedToDrinkMoreThanPossessed)
    ...
    def test_drink13(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drink.QuantityUnclear)
...
class Test_Drop(unittest.TestCase):
    ...
    def test_drop_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drop.QuantityUnclear)
    ...
    def test_drop_3(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drop.TryingToDropItemYouDontHave)
    ...
    def test_drop_4(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drop.TryingToDropMoreThanYouHave)
    ...
    def test_drop_6(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.drop.DroppedItem)
        self.assertEqual(result[0].item_title, 'gold coin')
    ...
    def test_drop_9(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.ItemUnequipped)
        ...
        self.assertIsInstance(result[1], advg.statemsgs.drop.DroppedItem)
...
class Test_Equip_1(unittest.TestCase):
    ...
    def test_equip_1(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.equip.NoSuchItemInInventory)
        self.assertEqual(result[0].item_title, 'longsword')
        self.assertEqual(result[0].message, "You don't have a longsword in your inventory.")

    def test_equip_2(self):
        result = self.command_processor.process('equip longsword')
        self.assertIsInstance(result[0], advg.statemsgs.equip.ClassCantUseItem)
        self.assertEqual(result[0].item_title, 'longsword')
        self.assertEqual(result[0].item_type, 'weapon')
    ...
    def test_equip_5(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.ItemEquipped)
        self.assertEqual(result[0].item_title, 'magic wand')
        self.assertEqual(result[0].item_type, 'wand')
...
class Test_Help_1(unittest.TestCase):
    ...
    def test_help_1(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.help_.DisplayCommands)
...
""")
    ...
    def test_help_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.help_.CommandNotRecognized)
...
""")
    ...
    def test_help_3(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.help_.DisplayHelpForCommand)
        self.assertEqual(result[0].command, 'ATTACK')
...
class Test_Inventory(unittest.TestCase):
    ...
    def test_inventory_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.inven.DisplayInventory)
...
class Test_Leave(unittest.TestCase):
    ...
    def test_leave_3(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.leave.LeftRoom)
    ...
    def test_leave_5(self):
        ...
        result = self.command_processor.process('leave using north door')
        self.assertIsInstance(result[0], advg.statemsgs.leave.DoorIsLocked)
        self.assertEqual(result[0].compass_dir, 'north')
        self.assertEqual(result[0].portal_type, 'door')
        ...
        self.assertEqual(result[0].compass_dir, 'north')
        self.assertEqual(result[0].message, 'You leave the room via the north door.')
        self.assertIsInstance(result[1], advg.statemsgs.leave.WonTheGame)
...
class Test_Lock(unittest.TestCase):
    ...
    def test_lock_3(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.lock.DontPossessCorrectKey)
    ...
    def test_lock_4(self):
        ...
        result = self.command_processor.process(f'lock {self.door_title}')
        self.assertIsInstance(result[0], advg.statemsgs.lock.ElementIsAlreadyUnlocked)
        self.assertEqual(result[0].target, self.door_title)
        ...
        self.door.is_locked = False
        result = self.command_processor.process(f'lock {self.door_title}')
        self.assertIsInstance(result[0], advg.statemsgs.lock.ElementHasBeenUnlocked)
        self.assertEqual(result[0].target, self.door_title)
    ...
    def test_lock_8(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.lock.ElementNotUnlockable)
        self.assertEqual(result[0].target_title, 'mana potion')
        self.assertEqual(result[0].target_type, 'potion')
...
class Test_Look_At_2(unittest.TestCase):
    ...
    def test_look_at_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.ContainerNotFound)
    ...
    def test_look_at_19(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.AmbiguousDoorSpecifier)
...
class Test_Processor_Process(unittest.TestCase):
    ...
    def test_command_not_recognized_in_pregame(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_CommandNotRecognized)
    ...
    def test_command_not_allowed_in_pregame(self):
        ...
        self.assertIsInstance(result[0], advg.Stmsg_CommandNotAllowedNow)
        self.assertEqual(result[0].command, 'attack')
...
class Test_Put(unittest.TestCase):
    ...
    def test_put_5(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.take.ItemNotFoundInContainer)
        self.assertEqual(result[0].container_title, 'wooden chest')
        self.assertEqual(result[0].amount_attempted, 1)
        self.assertEqual(result[0].container_type, 'chest')
        self.assertEqual(result[0].item_title, 'short sword')
    ...
    def test_put_6(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.various.ContainerIsClosed)
...
class Test_Set_Name_Vs_Set_Class_Vs_Reroll_Vs_Begin_Games(unittest.TestCase):
    ...
    def test_begin_game_5(self):
        ...
        self.command_processor.process('set name to Kerne')
        result = self.command_processor.process('reroll')
        self.assertIsInstance(result[0], advg.statemsgs.various.DisplayRolledStats)
    ...
    def test_set_name_vs_set_class_1(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.setname.NameSet)
    ...
    def test_set_name_vs_set_class_4(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.setname.InvalidPart)
        ...
        self.assertEqual(result[0].message, 'The name MacDonald0 is invalid; must be a capital letter followed by '
                                            'lowercase letters.')
        self.assertIsInstance(result[1], advg.statemsgs.setname.InvalidPart)
...
class Test_Status(unittest.TestCase):
    ...
    def test_status2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.status.StatusOutput)
...
class Test_Take(unittest.TestCase):
    ...
    def test_take_1(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.take.ItemOrItemsTaken)
    ...
    def test_take_7(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.take.TryingToTakeMoreThanIsPresent)
        self.assertEqual(result[0].container_title, 'kobold corpse')
        self.assertEqual(result[0].container_type, 'corpse')
...
class Test_Unequip_1(unittest.TestCase):
    ...
    def test_unequip_2(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.unequip.ItemNotEquipped)
...
class Test_Unlock(unittest.TestCase):
    ...
    def test_unlock_3(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.unlock.DontPossessCorrectKey)
    ...
    def test_unlock_4(self):
        ...
        self.command_processor.game_state.character.pick_up_item(key)
        result = self.command_processor.process(f'unlock {self.door_title}')
        self.assertIsInstance(result[0], advg.statemsgs.unlock.ElementIsAlreadyLocked)
        self.assertEqual(result[0].target, self.door_title)
        ...
        self.door.is_locked = True
        result = self.command_processor.process(f'unlock {self.door_title}')
        self.assertIsInstance(result[0], advg.statemsgs.unlock.ElementHasBeenLocked)
        self.assertEqual(result[0].target, self.door_title)
    ...
    def test_unlock_8(self):
        ...
        self.assertIsInstance(result[0], advg.statemsgs.unlock.ElementNotLockable)
        self.assertEqual(result[0].target_title, 'mana potion')
        self.assertEqual(result[0].target_type, 'potion')
