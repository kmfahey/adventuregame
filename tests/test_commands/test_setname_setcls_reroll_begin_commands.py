...
class Test_Set_Name_Vs_Set_Class_Vs_Reroll_Vs_Begin_Game(TestCase):
    ...
    def test_begin_game_5(self):
        ...
        self.command_processor.process("set name to Kerne")
        result = self.command_processor.process("reroll")
        self.assertIsInstance(result[0], DisplayRolledStatsGSM)
    ...
    def test_set_name_vs_set_class_1(self):
        ...
        self.assertIsInstance(result[0], ClassSetGSM)
    ...
    def test_set_name_vs_set_class_4(self):
        ...
        self.assertIsInstance(result[0], InvalidPartGSM)
        ...
        self.assertIsInstance(result[1], InvalidPartGSM)
        ...
        self.assertIsInstance(result[0], InvalidClassGSM)
