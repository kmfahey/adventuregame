...
class Test_Close(TestCase):
    ...
    def test_close_2(self):
        ...
        self.assertIsInstance(result[0], ElementIsAlreadyClosedGSM)
    ...
    def test_close_3(self):
        ...
        result = self.command_processor.process(f"close {self.chest_title}")
        self.assertIsInstance(result[0], ElementHasBeenClosedGSM)
        self.assertEqual(result[0].target, self.chest_title)
    ...
    def test_close_9(self):
        ...
        self.assertIsInstance(result[0], ElementNotCloseableGSM)
