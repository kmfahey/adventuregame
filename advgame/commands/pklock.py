...
def pick_lock_command(game_state, tokens):
    ...
    * Otherwise, the specified door or chest has its is_locked attribute set
    ...
    if (
        ...
        return (BadSyntaxGSM("PICK LOCK", COMMANDS_SYNTAX["PICK LOCK"]),)
