...
def cast_spell_command(context, tokens):
    ...
    * If the character is a Warrior or a Thief, returns a
    .stmsg.command.ClassRestrictedGSM object.

    * This command costs mana points. If the character doesn't have enough,
    returns a .stmsg.castspl.InsufficientManaGSM object.

    * If the character is a Mage and there's no creature in the room,
    returns a .stmsg.castspl.NoCreatureToTargetGSM object.
    ...
    * If they're a Mage and there is a creature present, a damaging spell
    ...
    .stmsg.castspl.CastDamagingSpellGSM object followed by the object(s)
    generated by the creature's followup attack.

    * If the creature is killed, returns a .stmsg.castspl.CastDamagingSpellGSM
    object and a .stmsg.various.FoeDeathGSM object.

    * If the character is a Priest, returns a
    .stmsg.castspl.CastHealingSpellGSM object and a
    ...
    if game_state.character_class not in ("Mage", "Priest"):
        return (stmsg.command.ClassRestrictedGSM("CAST SPELL", "mage", "priest"),)

    # This command takes no arguments, so if any were used a syntax
    # error is returned.
    elif len(tokens):
        return (stmsg.command.BadSyntaxGSM("CAST SPELL", COMMANDS_SYNTAX["CAST SPELL"]),)
    ...
    # an insufficient-mana error is returned.
        ...
        return (
            stmsg.castspl.InsufficientManaGSM(
    ...
    # handles the Mage and Priest cases separately.
        ...
        if game_state.rooms_state.cursor.creature_here is None:
            return (stmsg.castspl.NoCreatureToTargetGSM(),)
        else:
            ...
            if creature.is_dead:
                ...
                return (
                    stmsg.castspl.CastDamagingSpellGSM(
        ...
        game_state.character.spend_mana(SPELL_MANA_COST)
        return (
            stmsg.castspl.CastHealingSpellGSM(),
