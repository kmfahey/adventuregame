...
def cast_spell_command(context, tokens):
    ...
    * If the character is a Warrior or a Thief, returns a ClassRestrictedGSM
    object.
    ...
    * If they're a Mage and there is a creature present, a damaging spell
    ...
    CastDamagingSpellGSM object followed by the object(s) generated by the
    creature's followup attack.

    * If the creature is killed, returns a CastDamagingSpellGSM object and a
    FoeDeathGSM object.

    * If the character is a Priest, returns a CastHealingSpellGSM object and
    a UnderwentHealingEffectGSM object.
    """
