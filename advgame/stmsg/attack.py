...
class AttackHitGSM(GameStateMessage):
    ...
    @property
    def message(self):
        # This message property returns a message announcing the result
        # of a successful attack on a creature in one of four cases:
        #
        # The attack was with a weapon and the creature died.
        if self.creature_slain and self.weapon_type == "weapon":
            return (
                f"Your attack on the {self.creature_title} hit! You did "
                + f"{self.damage_done} damage."
            )
        # The attack was with a wand and the creature died.
        elif self.creature_slain and self.weapon_type == "wand":
            return (
                f"A bolt of energy from your wand hits the "
                + f"{self.creature_title}! You did {self.damage_done} damage. "
        ...
        # they're counterattacking.
            ...
            return (
                f"Your attack on the {self.creature_title} hit! You did "
                + f"{self.damage_done} damage. The {self.creature_title} "
                + "turns to attack!"
            )
...
class AttackMissedGSM(GameStateMessage):
    ...
    def message(self):
        # This message property returns a message announcing the result
        # of a failed attack on a creature in one of two cases:
        #
        # The attack was with a weapon, and the creature is
        # counterattacking.
        if self.weapon_type == "weapon":
            return (
                f"Your attack on the {self.creature_title} missed. It turns "
                + "to attack!"
            )
        ...
        # counterattacking.
            ...
            return (
                f"A bolt of energy from your wand misses the "
...
class OpponentNotFoundGSM(GameStateMessage):
    ...
    def message(self):
        ...
        if self.opponent_present:
            return (
                f"This room doesn't have a {self.creature_title_given}; but "
                + f"there is a {self.opponent_present}."
            )
        # There is no creature in this room.
        else:
            return (
                f"This room doesn't have a {self.creature_title_given}; "
                + "nobody is here."
            )
...
class YouHaveNoWeaponOrWandEquippedGSM(GameStateMessage):
    ...
    def message(self):
        # This message property handles two cases:
        #
        # The player's character is a Mage and has neither a wand or a
        # weapon equipped.
        if self.character_class == "Mage":
            return "You have no wand or weapon equipped; you can't attack."
        # The player's character is a Warrior, Thief or Priest and has
        # no weapon equipped.
        else:
